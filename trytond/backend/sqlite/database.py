...
if CONFIG['db_type'] == 'sqlite':
    try:
        ...
        from pysqlite2.dbapi2 import OperationalError as \
    ...
    from pyspatialite.dbapi2 import IntegrityError as DatabaseIntegrityError
    from pyspatialite.dbapi2 import OperationalError as DatabaseOperationalError
