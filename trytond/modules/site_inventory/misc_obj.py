...
class MiscObjRenderer(ModelSQL, ModelView):
    ...
    site = fields.Many2One('site_inventory.site_inventory', 'Site', required=True)
...
class MiscObjPoly(MiscObjRenderer):
    ...
    __name__ = 'site_inventory.misc_obj_poly'
...
class MiscObjPolyQGis(QGis):
    __name__ = 'site_inventory.misc_obj_poly.qgis'
    TITLES = {'site_inventory.misc_obj_poly': u'Miscellaneous polygon objects'}


class MiscObjLine(MiscObjRenderer):
    'Miscellaneous line object'
    __name__ = 'site_inventory.misc_obj_line'
    ...
    @classmethod
    @ModelView.button_action('site_inventory.report_misc_obj_line_edit')
    def misc_obj_line_edit(cls, ids):
        pass


class MiscObjLineQGis(QGis):
    __name__ = 'site_inventory.misc_obj_line.qgis'
    TITLES = {'site_inventory.misc_obj_line': u'Miscellaneous line objects'}


class MiscObjPoint(MiscObjRenderer):
    'Miscellaneous point object'
    __name__ = 'site_inventory.misc_obj_point'
    ...
    @classmethod
    @ModelView.button_action('site_inventory.report_misc_obj_point_edit')
    def misc_obj_point_edit(cls, ids):
        pass


class MiscObjPointQGis(QGis):
    __name__ = 'site_inventory.misc_obj_point.qgis'
    TITLES = {'site_inventory.misc_obj_point': u'Miscellaneous point objects'}
