...
class Canton(Mapable, ModelSQL, ModelView):
    ...
    @classmethod
    @ModelView.button_action('portrait.report_canton_edit')
...
class CantonQGis(QGis):
    __name__ = 'portrait.canton.qgis'
    TITLES = {'portrait.canton': u'Canton'}

class GenerateCa(Wizard):
    __name__ = 'portrait.canton_generate'

    @classmethod
    def execute(cls, session, data, state_name):
        canton = Pool().get('portrait.canton')
