...
class Departement:
    ...
    def deleteOldDepartement(cls):
        departement_model = Pool().get('mae.departement')
...
class DepartementFile(ModelView):
    'Import File'
    __name__ = 'mae_download_shape.departement.file'
...
class WizardDepartementFile(Wizard):
    ...
    done = StateView('mae_download_shape.departement.done', 'mae_download_shape.departement_done_view_form',
...
class ImportDepartement(ModelView, ModelSQL):
    ...
    __name__ = 'mae_download_shape.departement.importer'
