...
class Region:
    ...
    def deleteOldRegion(cls):
        region_model = Pool().get('mae.region')
...
class RegionFile(ModelView):
    'Import File'
    __name__ = 'mae_download_shape.region.file'
...
class WizardRegionFile(Wizard):
    ...
    done = StateView('mae_download_shape.region.done', 'mae_download_shape.region_done_view_form',
...
class ImportRegion(ModelView, ModelSQL):
    ...
    __name__ = 'mae_download_shape.region.importer'
