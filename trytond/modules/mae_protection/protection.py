...
class Area(Mapable, ModelSQL, ModelView):
    ...
    def default_espace(cls):
        ...
        model = Pool().get('mae_protection.type')
    ...
    @classmethod
    @ModelView.button_action('mae_protection.report_area_edit')
    def area_edit(cls, ids):
        pass


class AreaQGis(QGis):
    __name__ = 'mae_protection.area.qgis'
    TITLES = {'mae_protection.area': u'Area'}
...
class ReserveBiologique(Mapable, ModelSQL, ModelView):
    ...
    __name__ = 'mae_protection.reserve_biologique'
    ...
    @classmethod
    @ModelView.button_action('mae_protection.report_rb_edit')
    def reserve_biologique_edit(cls, ids):
        pass


class ReserveBiologiqueQGis(QGis):
    __name__ = 'mae_protection.reserve.biologique.qgis'
    TITLES = {'mae_protection.reserve_biologique': u'Reserve biologique'}


class Zico(Mapable, ModelSQL, ModelView):
    u'ZICO area'
    __name__ = 'mae_protection.zico'
    ...
    @classmethod
    @ModelView.button_action('mae_protection.report_zico_edit')
    def zico_edit(cls, ids):
        pass


class ZicoQGis(QGis):
    __name__ = 'mae_protection.zico.qgis'
    TITLES = {'mae_protection.zico': u'ZICO'}

class GenerateAll(Wizard):
    __name__ = 'mae_protection.generateall'

    @classmethod
    def execute(cls, session, data, state_name):
        model = Pool().get('mae_protection.area')
