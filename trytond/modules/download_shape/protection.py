...
class Protection:
    ...
    def _checkType(cls, type, code):
        ...
        type_model = Pool().get('protection.type')
    ...
    def createGeometries(cls, filename, type = None, code = None, rules = None,
                         version = None):
        area_model = Pool().get('protection.area')
        typeId = None
        if rules == None:
            typeId = cls._checkType(type, code)
        # Suppression des anciennes donnees
        cls._deleteOld(code, rules, 'protection.area')
    ...
    def createBioGeometries(cls, filename, type = None, code = None,
        ...
        bio_model = Pool().get('protection.reserve_biologique')
        area_model = Pool().get('protection.area')
        if rules == None:
            typeId = cls._checkType(type, code)
        # Suppression des anciennes donnees
        cls._deleteOld(code, rules, 'protection.reserve_biologique')
        cls._deleteOld(code, rules, 'protection.area')
        # Initialisation de la lecture du fichier
        srs = osr.SpatialReference()
        srs.ImportFromEPSG(2154)
    ...
    def createZicoGeometries(cls, filename, type, code, version):
        zico_model = Pool().get('protection.zico')
        area_model = Pool().get('protection.area')
        typeId = cls._checkType(type, code)
        # Suppression des anciennes donnees
        cls._deleteOld(code, None, 'protection.zico')
        cls._deleteOld(code, None, 'protection.area')
        # Initialisation de la lecture du fichier
        srs = osr.SpatialReference()
        srs.ImportFromEPSG(2154)
...
class ProtectionFile(ModelView):
    'Import File'
    __name__ = 'download_shape.protection.file'
...
class ProtectionDone(ModelView):
    'Import Done'
    __name__ = 'download_shape.protection.done'


class RamsarFile(Wizard):
    'Import ramsar file'
    __name__ = 'download_shape.protection.ramsar'
...
class BiotopeFile(Wizard):
    ...
    __name__ = 'download_shape.protection.biotope'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ParcNatFile(Wizard):
    ...
    __name__ = 'download_shape.protection.parcnat'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ParcMarinFile(Wizard):
    ...
    __name__ = 'download_shape.protection.parcmarin'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ParcRegFile(Wizard):
    ...
    __name__ = 'download_shape.protection.parcreg'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ResRegFile(Wizard):
    ...
    __name__ = 'download_shape.protection.resreg'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ResNatFile(Wizard):
    ...
    __name__ = 'download_shape.protection.resnat'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ResCorseFile(Wizard):
    ...
    __name__ = 'download_shape.protection.rescorse'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ResNatCFFile(Wizard):
    ...
    __name__ = 'download_shape.protection.resnatcf'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class SicFile(Wizard):
    ...
    __name__ = 'download_shape.protection.sic'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ZpsFile(Wizard):
    ...
    __name__ = 'download_shape.protection.zps'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class BioFile(Wizard):
    ...
    __name__ = 'download_shape.protection.bio'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class LittoralFile(Wizard):
    ...
    __name__ = 'download_shape.protection.littoral'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class CenFile(Wizard):
    ...
    __name__ = 'download_shape.protection.cen'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ResBioFile(Wizard):
    ...
    __name__ = 'download_shape.protection.resbio'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ZicoFile(Wizard):
    ...
    __name__ = 'download_shape.protection.zico'
    type = fields.Char(string=u'Type de donnée',
                       help=u'Nom de la couche de protection',
                       required=True)
...
class ImportProtection(ModelView, ModelSQL):
    ...
    __name__ = 'download_shape.protection.importer'
